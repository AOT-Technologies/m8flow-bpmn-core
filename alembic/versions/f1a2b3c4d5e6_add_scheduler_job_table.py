...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("locked_at_in_seconds", sa.BigInteger(), nullable=True),
        sa.Column("run_at_in_seconds", sa.BigInteger(), nullable=False),
        sa.Column("payload_json", sa.JSON(), nullable=False),
        sa.Column("updated_at_in_seconds", sa.BigInteger(), nullable=False),
        sa.Column("created_at_in_seconds", sa.BigInteger(), nullable=False),
